        ...
        <div className={estilos.columnaLogo}>
          ...
          <div className={estilos.redesSociales}>
            {CONTACTO.redesSociales.instagram && (
              ...
              >
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" className={estilos.iconoRed}>
                ...
                <span className={estilos.etiquetaRed}>Instagram</span>
              </a>
            )}
            {CONTACTO.redesSociales.facebook && (
              ...
              >
                ...
                <span className={estilos.etiquetaRed}>Facebook</span>
              </a>
            )}
          </div>
        </div>
